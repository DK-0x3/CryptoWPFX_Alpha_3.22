<div align="center">
  <h1 align="center" font-size=24>Приложение для просмотра криптовалют 'RGE'</h1>
</div>

---

### Описание
Приложение 'RGE' - это удобный инструмент для отслеживания и анализа криптовалютных рынков. С помощью этого приложения пользователи могут легко просматривать информацию о популярных криптовалютах, добавлять их в избранное, а также получать доступ к актуальным ценам на всех крупных криптобиржах. Пользователи также могут конвертировать валюту между различными криптовалютами.
